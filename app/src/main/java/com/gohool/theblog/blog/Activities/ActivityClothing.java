...
//        Log.d("one",image);
        ...
        mDatabaseReference = mDatabase.getReference().child("MBlog").child("Clothing");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Toast.makeText(getApplicationContext(), blog.getTitle() + " is selected!", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(ActivityClothing.this,BuyItem.class);
...
//                break;
            case R.id.action_signout:
                ...
                if (mUser != null && mAuth != null) {
                    ...
                    startActivity(new Intent(ActivityClothing.this, FirstActivity.class));
                    finish();
    ...
    protected void onStart() {
        ...
        mDatabaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                blogRecyclerAdapter = new BlogRecyclerAdapter(ActivityClothing.this,blogList);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ActivityClothing.this, ShowProductActivity.class));
        finish();
        super.onBackPressed();
    }
}
