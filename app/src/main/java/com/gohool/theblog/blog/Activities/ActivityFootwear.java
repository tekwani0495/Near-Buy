...
//        Log.d("one",image);
        ...
        mDatabaseReference = mDatabase.getReference().child("MBlog").child("FootWear");
...
//                break;
            case R.id.action_signout:
                ...
                if (mUser != null && mAuth != null) {
                    ...
                    startActivity(new Intent(ActivityFootwear.this, CustomerLogin.class));
                    finish();
    ...
    protected void onStart() {
        ...
        mDatabaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                blogRecyclerAdapter = new BlogRecyclerAdapter(ActivityFootwear.this,blogList);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ActivityFootwear.this, ShowProductActivity.class));
        finish();
        super.onBackPressed();
    }
}
