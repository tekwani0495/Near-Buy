...
//        Log.d("one",image);
        ...
        mDatabaseReference = mDatabase.getReference().child("MBlog").child("Food");
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent=new Intent(ActivityFood.this,BuyItem.class);
...
//                break;
            case R.id.action_signout:
                ...
                if (mUser != null && mAuth != null) {
                    ...
                    startActivity(new Intent(ActivityFood.this, FirstActivity.class));
                    finish();
    ...
    protected void onStart() {
        ...
        mDatabaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                blogRecyclerAdapter = new BlogRecyclerAdapter(ActivityFood.this,blogList);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ActivityFood.this, ShowProductActivity.class));
        finish();
        super.onBackPressed();
    }
